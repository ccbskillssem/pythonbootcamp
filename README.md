...
## Zoom
Link to the zoom is [here](). Lectures are recorded and will be posted on the PyCamp slack when they are ready!
...
| **Day 5** (Friday) | Introduction to Machine Learning and running Python locally | [Friday AM+PM](Coming soon!) | | [Day 5 cheatsheet]() | [AM+PM solutions]()
